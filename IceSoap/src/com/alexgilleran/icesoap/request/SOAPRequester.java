...
public interface SOAPRequester {
	 ...
	 *
	 * @param envelope  The SOAP envelope to send
	 * @param targetUrl The url of the SOAP web service to communicate with.
	 * @return An InputStream representing the
	 * @throws IOException If an exception occurs while performing the request
	 */
	Response doSoapRequest(SOAPEnvelope envelope, String targetUrl) throws IOException;
	 ...
	 * @param envelope   The SOAP envelope to send
	 * @param targetUrl  The url of the SOAP web service to communicate with.
	 * @param soapAction The SOAP Action to perform - this is put in the
	 *                   <code>SOAPAction</code> field of the outgoing HTTP post.
	 * @return An InputStream representing the
	 * @throws IOException If an exception occurs while performing the request
	 */
	Response doSoapRequest(SOAPEnvelope envelope, String targetUrl, String soapAction) throws IOException;
