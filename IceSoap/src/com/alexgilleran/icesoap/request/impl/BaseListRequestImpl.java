 ...
 */
public class BaseListRequestImpl<ResultType, SOAPFaultType> extends
		BaseRequestImpl<List<ResultType>, SOAPFaultType> implements
	 ...
	 *            requests.
	 */
	protected BaseListRequestImpl(String url, SOAPEnvelope soapEnv,
	...
	/**
	 * Subclass of {@link BaseRequestImpl} RequestTask that caters for mid-request
	...
	private class ListRequestTask extends RequestTask<ResultType> {
		...
		protected void onProgressUpdate(ResultType... item) {
			itemRegistry.notifyNewItem(BaseListRequestImpl.this, item[0]);
		}
